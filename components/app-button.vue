<template>
  <a :href="href" target="_blank" class="inline-flex items-center justify-center gap-4 rounded-md text-sm px-4 py-2 [&_svg]:w-[1.2em] border-primary border-2 text-primary hover:bg-primary hover:text-white transition-all">
