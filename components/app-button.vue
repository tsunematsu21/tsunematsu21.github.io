<template>
  <a :href="href" target="_blank" class="inline-flex items-center justify-between gap-4 rounded-md text-xs px-4 h-10 [&_svg]:h-6 border-primary border-2 text-primary transition-all font-sans font-black">
    <span class="-mb-[2px]">
      <slot />
    </span>
